/*Program 12. Write a program that copies the contents of the source singly linear linked list whose addition of digits is the prime number to the
destination singly linear linked list.
Input source linked list :|30|->|29|->|73|->|80|->|70|->|110|->|89|
Output destination linked list : |30|->|29|->|70|->|110|->|89|*/
...
void main(){
	printf("				12.Copy The Number Whose Digit Sum Is Prime Number\n");
        char ch;
        do{
                printf("1.Add Nodes\n2.Copy The Number Whose Digit Sum Is Prime Number\n3.PrintLL\n");
