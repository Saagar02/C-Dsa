/*Program 13. Write a program that accepts a source singly linear linked list and a destination singly linear linked list and check whether the 
source list is a sublist of the destination list. The function returns the first position at which the sub-list is found.
...
void main(){
	printf("						13.Find First Sublist\n");
        char ch;
        do{
                printf("1.Add Nodes\n2.Find First Sublist\n3.PrintLL\n");
                ...
                switch(choice){
                        ...
                        case 2 :{
                                if(nCount(head2)<=0){
                                        ...
                                        int retval = sublist();
					if(flag1 == 1){
						printf("First Sublist found at position no %d\n",retval);
					}else{
